...
lookfor.ai enables you to build multi-agent systems (MASs) that work 24/7 for your Shopify store. 
...
The concept is cool but its capabilities are limited. It cannot take actions, almost only words. In short, chatbots are also use LLMs but as a text answer generator. 
