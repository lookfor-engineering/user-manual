...
You can go to **Inbox** page to see your emails. You can send manual responses there, assign an email conversation to a [member](/user-manual/guides/others/members), or add tags to the email conversation.
...
3. Create agentt accordingly. See [Agents](/user-manual/guides/agents) guide for more details.
