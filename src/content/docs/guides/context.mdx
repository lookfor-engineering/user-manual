...
However, you can refer to the context variables in the [instructions](/user-manual/guides/prompt-engineering#personalizing-responses-with-context-variables) to achieve something specific.

## Context Variables
The context variables are different for each type of the MAS. See the list of the context variables for each type:

- **[Storefront MAS Context](/user-manual/guides/storefront-mas#context-variables)**
- **[Email MAS Context](/user-manual/guides/email-mas#context-variables)**
